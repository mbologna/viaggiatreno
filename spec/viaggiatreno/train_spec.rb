...
describe Train do
  ...
  describe '#to_s' do
    it { expect(@train.to_s).to eq "20241 REG 20241: Il treno e' arrivato con " + \
                                   '2 minuti di ritardo state: ARRIVED,    delay: 2, lastUpdate:  '
    }
  end
  ...
  describe '#trainStops' do
    ...
    it { expect(@train_stops.map(&:to_s)).to eq [
